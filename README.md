...
This package provides a solution for allowing user interaction with the underlying page while Braze In-App Messages (IAM) Survicate Surveys are displayed. It automatically detects Braze IAM iframes and applies dynamic clipping to create transparent areas that enable page interaction. **Note: This solution is specifically designed for web platforms and does not provide this functionality for mobile SDKs (iOS/Android), which also support in-app messages.**
